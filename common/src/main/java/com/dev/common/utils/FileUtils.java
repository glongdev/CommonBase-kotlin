...
public final class FileUtils {
     ...
     * @return 成功为true
     */
    public static boolean copyFile(@NonNull final InputStream input, @NonNull File destFile) {
//        if(destFile.exists()){
//            if (!deleteAllInDir(destFile)) {// unsuccessfully delete then return false
//                return false;
//            }
//        }
        try {
            ...
            copyFileUsingStreams(input, output);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static void copyFileUsingStreams(InputStream input, OutputStream output) throws IOException {
        try {
